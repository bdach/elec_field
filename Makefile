...
cpu_compute.o: cpu_compute.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

gpu_compute.o: gpu_compute.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

gpu_compute_kernel.o: gpu_compute_kernel.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
...
elec_field: cpu_compute.o gpu_compute.o gpu_compute_kernel.o main.o reader.o window.o
